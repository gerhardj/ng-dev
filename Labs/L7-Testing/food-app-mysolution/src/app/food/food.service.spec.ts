import {
  ...
  describe('Service - HttpTestingController', () => {
    ...
    it('should create a new food item', () => {
      fs.addFoodItem(foodAddItem as FoodItem).subscribe((f) => {
        expect(f).toBeTruthy();
      });
    ...
    it('should update a food item', () => {
      fs.updateFoodItem(foodUpdateItem as FoodItem).subscribe((f) => {
        expect(f).toBeTruthy();
      });
    ...
    it('should delete a food item', () => {
      fs.deleteFoodItem(foodDeleteItem.id).subscribe((f) => {
        expect(f).toEqual({});
      });
